...
CL_DEFMETHOD std::size_t RealSingleVector_O::dimension() const {
  return _Value.dimension();
}

CL_LAMBDA(vector index)
CL_LISPIFY_NAME("vref")
CL_DEFMETHOD float RealSingleVector_O::vref(std::size_t index) const {
  return _Value[index];
}

CL_LAMBDA(vector new-value index)
CL_LISPIFY_NAME("setf_vref")
CL_DEFMETHOD float RealSingleVector_O::setf_vref(float new_value, std::size_t index) {
  return _Value[index] = new_value;
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l1_norm")
CL_DEFMETHOD r1 RealSingleVector_O::l1_norm() const {
  return _Value.l1_norm();
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l2_norm")
CL_DEFMETHOD r1 RealSingleVector_O::l2_norm() const {
  return _Value.l2_norm();
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l2_norm_sqr")
CL_DEFMETHOD r1 RealSingleVector_O::l2_norm_sqr() const {
  return _Value.l2_norm_sqr();
}
...
CL_LAMBDA(vector)
CL_LISPIFY_NAME("dimension")
CL_DEFMETHOD std::size_t RealDoubleVector_O::dimension() const {
  return _Value.dimension();
}

CL_LAMBDA(vector index)
CL_LISPIFY_NAME("vref")
CL_DEFMETHOD double RealDoubleVector_O::vref(std::size_t index) const {
  return _Value[index];
}

CL_LAMBDA(vector new-value index)
CL_LISPIFY_NAME("setf_vref")
CL_DEFMETHOD double RealDoubleVector_O::setf_vref(double new_value, std::size_t index) {
  return _Value[index] = new_value;
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l1_norm")
CL_DEFMETHOD r2 RealDoubleVector_O::l1_norm() const {
  return _Value.l1_norm();
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l2_norm")
CL_DEFMETHOD r2 RealDoubleVector_O::l2_norm() const {
  return _Value.l2_norm();
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l2_norm_sqr")
CL_DEFMETHOD r2 RealDoubleVector_O::l2_norm_sqr() const {
  return _Value.l2_norm_sqr();
}
...
CL_LAMBDA(vector)
CL_LISPIFY_NAME("dimension")
CL_DEFMETHOD std::size_t ComplexSingleVector_O::dimension() const {
  return _Value.dimension();
}

CL_LAMBDA(vector index)
CL_LISPIFY_NAME("vref")
CL_DEFMETHOD c1 ComplexSingleVector_O::vref(std::size_t index) const {
  return _Value[index];
}

CL_LAMBDA(vector new-value index)
CL_LISPIFY_NAME("setf_vref")
CL_DEFMETHOD c1 ComplexSingleVector_O::setf_vref(c1 new_value, std::size_t index) {
  return _Value[index] = new_value;
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l1_norm")
CL_DEFMETHOD c1 ComplexSingleVector_O::l1_norm() const {
  return _Value.l1_norm();
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l2_norm")
CL_DEFMETHOD c1 ComplexSingleVector_O::l2_norm() const {
  return _Value.l2_norm();
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l2_norm_sqr")
CL_DEFMETHOD c1 ComplexSingleVector_O::l2_norm_sqr() const {
  return _Value.l2_norm_sqr();
}
...
CL_LAMBDA(vector)
CL_LISPIFY_NAME("dimension")
CL_DEFMETHOD std::size_t ComplexDoubleVector_O::dimension() const {
  return _Value.dimension();
}

CL_LAMBDA(vector index)
CL_LISPIFY_NAME("vref")
CL_DEFMETHOD c2 ComplexDoubleVector_O::vref(std::size_t index) const {
  return _Value[index];
}

CL_LAMBDA(vector new-value index)
CL_LISPIFY_NAME("setf_vref")
CL_DEFMETHOD c2 ComplexDoubleVector_O::setf_vref(c2 new_value, std::size_t index) {
  return _Value[index] = new_value;
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l1_norm")
CL_DEFMETHOD c2 ComplexDoubleVector_O::l1_norm() const {
  return _Value.l1_norm();
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l2_norm")
CL_DEFMETHOD c2 ComplexDoubleVector_O::l2_norm() const {
  return _Value.l2_norm();
}

CL_LAMBDA(vector)
CL_LISPIFY_NAME("l2_norm_sqr")
CL_DEFMETHOD c2 ComplexDoubleVector_O::l2_norm_sqr() const {
  return _Value.l2_norm_sqr();
}
